...
<jsp:include page="../header.jsp"></jsp:include>
 <jsp:include page="../sidebar.jsp"></jsp:include>
    ...
    <div class="content">
        ...
        <p align="right" style="pitch: medium;"><a href="<%=application.getContextPath()%>/task/taskaddForm.do?pno=${pno}" >작업 추가</a></p>
    ...
    <table class="table" >
      ...
      <tbody>
       ...
       <tr>
          ...
          <td>
              <a href="../task/taskdelete.do?tno=<%=t.getTno()%>&pno=<%=t.getPno()%>"><i class="icon-remove"></i></a>
          </td>
